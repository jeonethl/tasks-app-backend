...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.signUp = function (authCredentialsDto) {
    ...
    AuthService.prototype.signIn = function (authCredentialsDto) {
        return __awaiter(this, void 0, void 0, function () {
            var username, password, user, _a, payload, accessToken;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5: throw new common_1.UnauthorizedException("Please check your login credentials");
                }
            });
        });
    };
